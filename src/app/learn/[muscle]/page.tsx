  ...
  useEffect(() => {
    async function fetchExercises() {
      try {
        ...
        // Fetch all muscles first to build the mapping
        ...
        // Fetch exercises that target these muscles
        ...
        <div className="mx-auto max-w-md space-y-6 p-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-3">
              <span className="text-4xl">{muscleGroup.emoji}</span>
              <div>
